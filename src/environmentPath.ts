...
export class Environment {
  ...
  constructor(private context: vscode.ExtensionContext) {
    ...
    if (!this.isPortable) {
      ...
      console.log("this.USER_FOLDER:"+this.USER_FOLDER);
