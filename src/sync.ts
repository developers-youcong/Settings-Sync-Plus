...
export class Sync {
  ...
  public async bootstrap(): Promise<void> {
    ...
    if (await lockfile.Check(env.FILE_SYNC_LOCK)) {
      ...
      console.log("env.FILE_SYNC_LOCK:"+env.FILE_SYNC_LOCK);
    ...
    async function startGitProcess(
      ...
      if (completed) {
        try {
          ...
          console.log("customSettingsUpdated:"+customSettingsUpdated);
  ...
  public async download(): Promise<void> {
    ...
    try {
      ...
      console.log("localSettings.extConfig:"+localSettings.extConfig);
      
      console.log("localSettings.customConfig:"+localSettings.customConfig);
    ...
    async function StartDownload(
      ...
      console.log("customSettings.token:"+customSettings.token);

      console.log("customSettings.githubEnterpriseUrl:"+customSettings.githubEnterpriseUrl);
          ...
          if (file.gistName === env.FILE_EXTENSION_NAME) {
            ...
            if (writeFile) {
              ...
              if (file.filePath !== null) {
                ...
                console.log("filePath:"+filePath+"||"+env.USER_FOLDER+","+file.fileName);
