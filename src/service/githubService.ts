...
export class GitHubService {
  ...
  public async CreateEmptyGIST(
    ...
    console.log("创建空的GIST");
    if (publicGist) {

      console.log("publicGist true:"+publicGist);

      this.GIST_JSON_EMPTY.public = true;
    } else {
      console.log("publicGist false:"+publicGist);
  ...
  public UpdateGIST(gistObject: any, files: File[]): any {
    ...
    console.log("gistObject.data:"+gistObject.data);
  ...
  public async SaveGIST(gistObject: any): Promise<boolean> {
    ...
    console.log("gistObject.gist_id:"+gistObject.gist_id);
